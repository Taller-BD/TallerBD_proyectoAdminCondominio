...
CREATE TABLE ERRORES_DETECTADOS (
    error_id  NUMBER PRIMARY KEY NOT NULL,
...
CREATE TABLE registro_pagos (
    ...
    anno_mes_pcgc           NUMBER,
    id_edif                 NUMBER,
    nro_depto               NUMBER,
    fecha_cancelacion_pgc   DATE,
    monto_cancelado_pgc     NUMBER(12,2),
    id_fpago                NUMBER
);
    ...
    PROCEDURE sp_registrar_pago(
        ...
        IS
            BEGIN
                ...
                VALUES
                    (p_id_edif, p_nro_depto, p_anno_mes, SYSDATE, p_monto, p_id_fpago);
            EXCEPTION
                WHEN OTHERS THEN
                    pkg_registro_errores.sp_registrar_error(
